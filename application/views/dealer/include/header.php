...
foreach($loginuser as $loginuser){}
    if($loginuser->dealerImage == ""){
        ...
        $photo = base_url() . "assets/image/admin/".$loginuser->dealerImage;
    }
    ?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?= base_url(); ?>assets/admincss/main.css" type="text/css">

        <link rel="stylesheet" href="<?= base_url(); ?>assets/admincss/animate.css" type="text/css">
        <link rel="stylesheet" href="<?= base_url(); ?>assets/css/style.css" type="text/css">
        <link rel="stylesheet" href="<?= base_url(); ?>assets/admincss/default-skin.css" type="text/css">
        <link rel="stylesheet" href="<?= base_url(); ?>assets/admincss/photoswipe.css" type="text/css">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
        ...
        <!-- Date and Time css -->
        <!-- Sweet Alert Js -->
        <script src="<?= base_url(); ?>assets/adminjs/sweetalert.min.js"></script>
        <!-- Sweet Alert Js -->
        <script src="<?= base_url(); ?>assets/adminjs/jquery.min.js"></script>
        <script src="<?= base_url(); ?>assets/adminjs/pace.min.js"></script>
        <script src="<?= base_url(); ?>assets/adminjs/main.js"></script>
        <script src="https://code.jquery.com/jquery-3.2.1.slim.min.js"></script>
        <!-- Datatable -->
        <link rel="stylesheet" href="https://cdn.datatables.net/1.10.18/admincss/dataTables.bootstrap4.min.css">
    ...
    <body class="app sidebar-mini rtl">
        <header class="app-header">
            <a class="app-header__logo small-200" href="<?= base_url(); ?>dealer/index">
                <p class="text-truncate mb-0">CMS</p>
            </a>
            ...
            <script src="<?= base_url(); ?>assets/adminjs/highlight.js"> </script>
            <style type="text/css">
                .highlight {
                    color: red;
                    font-weight: 700;
            ...
            <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i class="fa fa-user-o fa-lg"></i></a>
                <ul class="dropdown-menu settings-menu dropdown-menu-right">
                    <span class="d-md-none">
                        <li>
                            <a class="dropdown-item" href="<?= base_url(); ?>dealer/logout"><i class="fa fa-sign-out fa-lg"></i> Logout</a>
                        </li>
                    </span>
                    <div class="dropdown-menu settings-menu dropdown-menu-right user-dd animated flipInY show d-none d-lg-block" style="width: 300px;">
                        <div class="d-flex no-block align-items-center p-3 mb-2">
                            ...
                            <div class="ml-3">
                                <h4 class="mb-0">
                                    <?= $loginuser->dealerFname; ?>
                                </h4>
                                <p class=" mb-0 text-muted">
                                    <?= $loginuser->dealerEmail; ?>
                                </p>
                                <a class="btn btn-danger my-3" href="<?= base_url(); ?>dealer/logout"><i class="fa fa-power-off mr-1 ml-1"></i> Logout</a>
                            </div>
                        </div>
    ...
    <?php include_once(APPPATH."views/dealer/include/sidebar.php");  ?> 

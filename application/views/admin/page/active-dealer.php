                    ...
                    <?php foreach($dealer as $dealer): ?>
                        <tr class="even" role="row">
                            ...
                            <td class="text-center">
                                ...
                                <button class="btn btn-sm btn-outline-success btn-circle btn-circle" onclick="dealerDeapprove(<?= $dealer->dealerId; ?>)"><i class="fa fa-times"></i></button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
...
<script type="text/javascript">
    ...
    function dealerDeapprove(id) {
        swal({
            title: "Are you sure?",
            text: "You really want to deactive",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#DD6B55",
            ...
            if (!isConfirm) return;
            $.ajax({
                url: "<?= base_url('admin/deapproveDealer/')?>" + id,
                type: "POST",

                success: function() {
                    location.reload();
                    swal("Done!", "It was succesfully Deactive!", "success");
                },
                error: function(xhr, ajaxOptions, thrownError) {

    ...
    <div class="col-lg-12 mt-4">
        ...
        <div class="row">
            <div class="col-lg-4 col-6">
                <form name="myForm" class="form-horizontal" id="myForm" action="<?= base_url('admin/ajax_upload_catimage/'. $cars->carId); ?>" method="POST" enctype="multipart/form-data">
...
<script>
    function deleteData(id) {
        swal({
            ...
            if (!isConfirm) return;
            $.ajax({
                url: "<?= base_url('admin/ajaxDeleteImage/')?>" + id,
                type: "POST",
                dataType: "JSON",
                success: function() {
                    location.reload();

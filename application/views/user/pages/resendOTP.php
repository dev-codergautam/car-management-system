        ...
        <div class="col-lg-12">
            <div class="row">
                ...
                <div class="col-lg-8 bg-white p-lg-5 p-3">
                    ...
                    <?= form_open('user/resendOTP/' . $sessionid); ?>
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Username is required">
                            <input class="input100" type="text" name="email" value="<?= $profile->u_email; ?>" readonly>
                       ...
                       <input type="text" name="otp" value="<?= $OTP; ?>" hidden="hidden">
                        ...
                        <div class="container-login100-form-btn mt-4">
                            <input class="login100-form-btn" type="submit" value="Resend OTP">
                        </div>
                        <?= form_close(); ?>
                </div>
                <div class="col-lg-2"></div>

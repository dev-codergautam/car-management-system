...
class Google{
    ...
    public function __construct(){
        ...
        require APPPATH .'third_party/Google-API-Client-CodeIgniter-Spark-master/src/Google_Client.php';
        require APPPATH .'third_party/Google-API-Client-CodeIgniter-Spark-master/src/contrib/Google_Oauth2Service.php';
